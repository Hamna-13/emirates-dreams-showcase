...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Curated palaces, penthouses and beachfront estates across the United Arab Emirates. Concierge-led property advisory since 2008." },
      { name: "author", content: "Emirates Royale" },
      { property: "og:title", content: "Emirates Royale — Luxury Real Estate in the UAE" },
      { property: "og:description", content: "Curated palaces, penthouses and beachfront estates across the UAE." },
